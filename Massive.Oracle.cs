...
namespace Massive.Oracle
{
    public static class ObjectExtensions
    {
        ...
        public static void AddParam(this DbCommand cmd, object item)
        {
            ...
            p.ParameterName = string.Format(":", cmd.Parameters.Count);
            if (item == null)
            {
    ...
    public class DynamicModel
    {
        ...
        public DynamicModel(string connectionStringName = "", string tableName = "", string primaryKeyField = "", string sequence = "")
        {
            TableName = tableName == "" ? this.GetType().Name : tableName;
            PrimaryKeyField = string.IsNullOrEmpty(primaryKeyField) ? "ID" : primaryKeyField;
            if (connectionStringName == "")
                connectionStringName = ConfigurationManager.ConnectionStrings[0].Name;
            var _providerName = "System.Data.OracleClient"; //reasonable default
