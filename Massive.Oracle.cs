...
namespace Massive.Oracle
{
    ...
    public class DynamicModel : DynamicObject
    {
        ...
        public DynamicModel(string connectionStringName, string tableName = "", string primaryKeyField = "", string descriptorField = "", string sequence = "")
        {
        ...
        /// <summary>Creates a new Expando from a Form POST - white listed
        /// against the columns in the DB</summary>
        ...
        /// <summary>Enumerates the reader yielding the result - thanks to
        /// Jeroen Haegebaert</summary>
        ...
        /// <summary>Creates a DBCommand that you can use for loving your
        /// database.</summary>
        ...
        /// (whatever PrimaryKeyField is set to) will be created at UPDATEs</summary>
        ...
        /// <summary>Conventionally introspects the object passed in for a field
        /// that looks like a PK. If you've named your PrimaryKeyField, this
        /// becomes easy</summary>
        ...
        /// clause and arguments, ordered as specified, limited (TOP) by limit.</summary>
        ...
        /// <summary>Returns a dynamic PagedResult. Result properties are Items,
        /// TotalPages, and TotalRecords.</summary>
        ...
        /// <summary>This will return a string/object dictionary for dropdowns
        /// etc</summary>
        ...
        /// <summary>Checks to see if a key is present based on the passed-in value</summary>
        ...
        /// <summary>Executes a set of objects as Insert or Update commands based
        /// on their property settings, within a transaction. These objects can
        /// be POCOs, Anonymous, NameValueCollections, or Expandos. Objects with
        /// a PK property (whatever PrimaryKeyField is set to) will be created
        /// at UPDATEs</summary>
        ...
        /// <summary>Creates a command for use with transactions - internal
        /// stuff mostly, but here for you to play with</summary>
        ...
        /// <summary>Removes one or more records from the DB according to the
        /// passed-in WHERE</summary>
        ...
        /// <summary>Temporary holder for error messages</summary>
        public IList<string> Errors = new List<string>();

        /// <summary>Adds a record to the database. You can pass in an Anonymous
        /// object, an ExpandoObject, a regular old POCO, or a
        /// NameValueColletion from a Request.Form or Request.QueryString</summary>
        ...
        /// Anonymous object, an ExpandoObject, a regular old POCO, or a
        /// NameValueCollection from a Request.Form or Request.QueryString</summary>
