...
namespace Massive
{
    ...
    public class DynamicModel : DynamicObject
    {
        ...
        /// based on their property settings, within a transaction. These objects
        /// can be POCOs, Anonymous, NameValueCollections, or Expandos. Objects
        /// with a PK property (whatever PrimaryKeyField is set to) will be
        /// created at UPDATEs</summary>
        ...
        /// <summary>Creates a command for use with transactions - internal stuff
        /// mostly, but here for you to play with</summary>
        ...
        /// <summary>Updates a all records in the database that match where
        /// clause. You can pass in an Anonymous object, an ExpandoObject, a
        /// regular old POCO, or a NameValueCollection from a Request.Form or
