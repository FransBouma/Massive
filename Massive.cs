...
namespace Massive
{
    ...
    {
        /// <summary>Extension method for adding an array of parameters to a DbCommand.</summary>
        ...
        /// <summary>Extension method for adding a single parameter to a DbCommand.</summary>
        ...
        /// <summary>Reads records from an IDataReader into a dynamic list, and returns the dynamic list.</summary>
        ...
        /// <summary>Reads the columns of a record into a dynamic (ExpandoObject), and returns the dynamic.</summary>
        ...
        /// <summary>Turns an object into a dynamic (ExpandoObject).</summary>
    ...
    /// <summary>Convenience class for opening/executing data.</summary>
    ...
    public class DynamicModel : DynamicObject
    {
        ...
        private IEnumerable<dynamic> schema;
        ...
        public DynamicModel(string connectionStringName, string tableName = "", string primaryKeyField = "", string descriptorField = "")
        {
            ...
            {
                dbProviderName = ConfigurationManager.ConnectionStrings[connectionStringName].ProviderName;
            }

            this.dbProviderFactory = DbProviderFactories.GetFactory(dbProviderName);
        ...
        /// <summary>Creates an empty Expando set with defaults from the DB.</summary>
        ...
        /// <summary>List out all the schema bits for use with ... whatever.</summary>
        public IEnumerable<dynamic> Schema
        {
            get
            {
                if (schema == null)
                {
                    schema = Query("SELECT * FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = @0", TableName);
                }
        ...
        /// <summary>Creates a new Expando from a Form POST - white listed against the columns in the DB.</summary>
        ...
        /// <summary>Returns and open DbConnectgion.</summary>
        public virtual DbConnection OpenConnection()
        {
            var result = dbProviderFactory.CreateConnection();
        ...
        /// <summary>Builds a set of Insert and Update commands based on the
        /// passed-on objects. These objects can be POCOs, Anonymous,
        /// NameValueCollections, or Expandos. Objects with a PK property
        /// (whatever PrimaryKeyField is set to) will be created at
        /// UPDATEs.</summary>
        ...
        /// <summary>Conventionally introspects the object passed in for a
        /// field that looks like a PK. If you've named your PrimaryKeyField,
        /// this becomes easy.</summary>
        public virtual bool HasPrimaryKey(object o)
        {
            return o.ToDictionary().ContainsKey(PrimaryKeyField);
        }

        /// <summary>If the object passed in has a property with the same name
        /// as your PrimaryKeyField it is returned here.</summary>
        ...
        /// <summary>Returns all records complying with the passed-in WHERE
        /// clause and arguments, ordered as specified, limited (TOP) by
        /// limit.</summary>
        ...
        /// <summary>Returns a dynamic PagedResult. Result properties are
        /// Items, TotalPages, and TotalRecords.</summary>
        ...
        /// <summary>This will return a string/object dictionary for dropdowns etc.</summary>
        ...
        /// <summary>This will return an Expando as a Dictionary.</summary>
        ...
        /// <summary>Executes a set of objects as Insert or Update commands
        /// based on their property settings, within a transaction. These
        /// objects can be POCOs, Anonymous, NameValueCollections, or Expandos.
        /// Objects with a PK property (whatever PrimaryKeyField is set to)
        /// will be created at UPDATEs.</summary>
        ...
        public virtual DbCommand CreateUpdateWhereCommand(dynamic expando, string where = "", params object[] args)
        {
            ...
            var counter = args.Length > 0 ? args.Length : 0;
        ...
        /// <summary>Adds a record to the database. You can pass in an Anonymous
        /// object, an ExpandoObject, a POCO, or a NameValueColletion from a
        /// Request.Form or Request.QueryString.</summary>
        ...
        /// <summary>Updates a record in the database. You can pass in an
        /// Anonymous object, an ExpandoObject, a POCO, or a NameValueCollection
        /// from a Request.Form or Request.QueryString.</summary>
        ...
        /// <summary>Updates a all records in the database that match the
        /// where clause. You can pass in an Anonymous object, an ExpandoObject,
        /// a POCO, or a NameValueCollection from a Request.Form or
        /// Request.QueryString. Where works same same as in All().</summary>
        /// <returns>
        ...
        /// <summary>A helpful query tool.</summary>
